...
```{r vis-direct-labels, fig.width=10, fig.height=10, fig.alt="A network plot of protein complexes with functional domain labels placed directly on the map."}
...
```{r vis-legend, fig.width=10, fig.height=10, fig.alt="A network plot of protein complexes where node color corresponds to a functional domain listed in a legend."}
